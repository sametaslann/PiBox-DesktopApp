...
Page {
    ...
    property var notificationsData: ludoController.notifications
    ...
    Image {
        ...
        Item{
            ...
            Text {
                ...
                width: 89
                height: 30
                text: ludoController.player1Text
            ...
            Text {
                ...
                width: 89
                height: 30
                text: ludoController.player2Text
                font.letterSpacing: 1
                color: "#17a81a"
                font.pixelSize: 22
                font.italic: false
            ...
            Text {
                ...
                width: 89
                height: 30
                text: ludoController.player3Text
                font.letterSpacing: 1
                color: "#e3f414"
                font.pixelSize: 22
                font.italic: false
            ...
            Text {
                ...
                width: 89
                height: 30
                text: ludoController.player4Text
                font.letterSpacing: 1
                color: "#3314f4"
                font.pixelSize: 22
                font.italic: false
        ...
        ProgressBar {
            ...
            width: 282
            height: 27
            value: ludoController.progressBar[0]
            padding: 2
        ...
        ProgressBar {
            ...
            width: 282
            height: 27
            value: ludoController.progressBar[1]
            padding: 2
        ...
        ProgressBar {
            ...
            width: 282
            height: 27
            value: ludoController.progressBar[2]
            padding: 2
        ...
        ProgressBar {
            ...
            width: 282
            height: 27
            value: ludoController.progressBar[3]
            padding: 2
